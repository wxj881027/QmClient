...
MACRO_CONFIG_INT(TcChatBubbleFontSizeLegacy, tc_chat_bubble_font_size, 12, 8, 24, CFGFLAG_CLIENT, "旧版聊天气泡设置")
MACRO_CONFIG_INT(TcChatBubbleTypingLegacy, tc_chat_bubble_typing, 1, 0, 1, CFGFLAG_CLIENT, "旧版聊天气泡设置")
MACRO_CONFIG_INT(TcChatBubbleMaxWidthLegacy, tc_chat_bubble_max_width, 200, 100, 400, CFGFLAG_CLIENT, "旧版聊天气泡设置")
MACRO_CONFIG_INT(TcChatBubbleOffsetYLegacy, tc_chat_bubble_offset_y, 50, 20, 100, CFGFLAG_CLIENT, "旧版聊天气泡设置")
MACRO_CONFIG_INT(TcChatBubbleRoundingLegacy, tc_chat_bubble_rounding, 10, 0, 30, CFGFLAG_CLIENT, "旧版聊天气泡设置")
...
MACRO_CONFIG_INT(TcChatBubbleZoomScaleLegacy, tc_chat_bubble_zoom_scale, 1, 0, 1, CFGFLAG_CLIENT, "旧版聊天气泡设置")
