...
MACRO_CONFIG_INT(TcUiTagVisual, tc_ui_tag_visual, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "配置筛选：只看视觉效果类")
MACRO_CONFIG_INT(TcUiTagHud, tc_ui_tag_hud, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "配置筛选：只看界面显示类")
MACRO_CONFIG_INT(TcUiTagInput, tc_ui_tag_input, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "配置筛选：只看输入优化类")
MACRO_CONFIG_INT(TcUiTagChat, tc_ui_tag_chat, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "配置筛选：只看聊天相关类")
MACRO_CONFIG_INT(TcUiTagAudio, tc_ui_tag_audio, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "配置筛选：只看语音音效类")
MACRO_CONFIG_INT(TcUiTagAutomation, tc_ui_tag_automation, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "配置筛选：只看自动化功能类")
MACRO_CONFIG_INT(TcUiTagSocial, tc_ui_tag_social, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "配置筛选：只看社交功能类")
MACRO_CONFIG_INT(TcUiTagCamera, tc_ui_tag_camera, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "配置筛选：只看相机视野类")
MACRO_CONFIG_INT(TcUiTagGameplay, tc_ui_tag_gameplay, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "配置筛选：只看玩法相关类")
MACRO_CONFIG_INT(TcUiTagMisc, tc_ui_tag_misc, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "配置筛选：只看其他杂项")
