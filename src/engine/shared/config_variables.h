...
MACRO_CONFIG_INT(QmConfigMigrationVersion, qm_config_migration_version, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "QmClient legacy configuration migration version")
...
MACRO_CONFIG_INT(QmPlayerIndicatorTeamOnly, qm_player_indicator_team_only, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show direction indicators only for players in your team")
